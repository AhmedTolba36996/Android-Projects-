...
import com.example.foodordering.FoodDetails;
...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.RecommendedViewHolder> {
    ...
    private List<Model_Recommended> recommendedList;

    public RecommendedAdapter(Context context, List<Model_Recommended> recommendedList) {
    ...
    public RecommendedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recommended_recycle_item, parent, false);
