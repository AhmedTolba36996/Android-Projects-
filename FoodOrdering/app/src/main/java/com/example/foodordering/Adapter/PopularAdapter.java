...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.PopularViewHolder> {
    ...
    private List<Model_Popular> popularList;

    public PopularAdapter(Context context, List<Model_Popular> popularList) {
    ...
    public PopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.popular_recycle_item, parent, false);
