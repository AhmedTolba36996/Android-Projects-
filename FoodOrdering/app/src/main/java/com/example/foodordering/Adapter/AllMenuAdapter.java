...
public class AllMenuAdapter extends RecyclerView.Adapter<AllMenuAdapter.AllMenuViewHolder> {
    ...
    Context context;
    List<Model_All_Menu> allmenuList;

    public AllMenuAdapter(Context context, List<Model_All_Menu> allmenuList) {
    ...
    public AllMenuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.all_menu_recycle_item, parent, false);
