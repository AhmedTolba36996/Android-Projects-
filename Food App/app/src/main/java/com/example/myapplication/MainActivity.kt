...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LoadFood()
        adapter = FoodAdapter(this , lista)
