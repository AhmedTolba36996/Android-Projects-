...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        veriFiyButton = findViewById(R.id.verify_btn);
    ...
    private void SetAnswer()
    {
        ...
        else
        {
            ...
            usersDataMAps.put("answer1" , answer1);
            usersDataMAps.put("answer2" , answer2);

            ref.child("Security Questions").updateChildren(usersDataMAps)
               ...
               public void onDataChange(@NonNull DataSnapshot snapshot) {
                   ...
                   if(snapshot.exists())
                   {
                       ...
                       if(snapshot.hasChild("Security Questions"))
                       {
                           ...
                           {
                               Toast.makeText(ResetPasswordActivity.this, "Your Seconed Answer is wrong", Toast.LENGTH_SHORT).show();
                           }
                           else
                           {
                       ...
                       {
                           Toast.makeText(ResetPasswordActivity.this, "You Have't set the security questions ", Toast.LENGTH_SHORT).show();
                       }

                   }
                   else 
                   {
                       Toast.makeText(ResetPasswordActivity.this, "This Phone number Dosen't exist", Toast.LENGTH_SHORT).show();
                   }
